...
function setup() 
{
  ...
  board1 = new Board(random(width - 200 ,1000), random(height - 300, height - 400), 50, 150);
  board2 = new Board(random(width - 150,1000), 400, 50, 200);
}
...
function gameOver()
{
  swal (
    {
      title: "Game Over",
      text: " Good Job! You scored "+score,
      imageUrl: 
      "https://rawgithubusercontent.com/vishalgaddam873/PiratesInvision/main/assets/board.png",
      imageSize: "150x150",
